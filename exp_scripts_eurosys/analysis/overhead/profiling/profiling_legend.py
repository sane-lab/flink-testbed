...
def DrawLegend(xvalues, yvalues, legend_labels, x_label, y_label, filename, allow_legend):
    # you may change the figure size on your own.
    fig = plt.figure(figsize=(10, 5))
    figure = fig.add_subplot(111)
    ...
    leg = figlegend.legend(lines, FIGURE_LABEL, prop=LEGEND_FP, \
                     loc=9,
...
if __name__ == '__main__':
    ...
    legend = False
    DrawLegend(x_axis, y_axis, legend_labels, "Elapsed Time (s)", "Memory Consumption (mb)", "profiling_legend", legend)