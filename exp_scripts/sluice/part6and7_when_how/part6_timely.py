...
exps_per_setting = {
    "linear_1": [
        ["Static",
         ...
         "black", "o"],
        # ["Earlier",
        #  "part6and7-microbench-streamsluice_earlier-streamsluice-part6-linear-1split2join1-120-2000-2000-960-linear-1000-1-1440-stair_3-120-1-1440-stair_3-1-0-2-600-1-1-2-600-1-1-2-600-1-1-6-1020-1--0.00-0.1-1000-3000-100-1-true-1",
        #  "purple", "o"],
        # ["Later",
        #  "part6and7-microbench-streamsluice_later-streamsluice-part6-linear-1split2join1-120-2000-2000-960-linear-1000-1-1440-stair_3-120-1-1440-stair_3-1-0-2-600-1-1-2-600-1-1-2-600-1-1-6-1020-1--0.00-0.1-1000-3000-100-1-true-1",
        #  "purple", "o"],
        ["DS2",
         ...
         "purple", "o"],
        ["Dhalion",
         "part6and7-microbench-dhalion-streamsluice-part6-linear-1split2join1-120-2000-2000-960-linear-1000-1-1440-stair_3-120-1-1440-stair_3-1-0-2-600-1-1-2-600-1-1-2-600-1-1-6-1020-1--0.00-0.1-1000-3000-100-1-true-1",
         "green", "o"],
        ["StreamSwitch",
         ...
         "orange", "o"],
        ["Sluice",
         "part6and7-microbench-streamsluice-streamsluice-part6-linear-1split2join1-120-2000-2000-960-linear-1000-1-1440-stair_3-120-1-1440-stair_3-1-0-2-600-1-1-2-600-1-1-2-600-1-1-6-1020-1--0.00-0.1-1000-3000-100-1-true-1",
         "blue", "o"],
    ],
    # "linear_1": [
    #     ["Static",
