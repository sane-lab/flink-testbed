...
def draw(rawDir, outputDir, exps, windowSize):
    ...
    axes.set_xticks(np.arange((startTime) * 1000, (startTime + expLength) * 1000 + 5000, 5000))
    axes.set_xticklabels([int((x - startTime * 1000) / 1000) for x in np.arange((startTime)  * 1000, (startTime + expLength) * 1000 + 5000, 5000)])
    ...
    axes.set_xticklabels([int((x - startTime * 1000) / 1000) for x in
                          np.arange((startTime) * 1000, (startTime + expLength) * 1000 + 5000, 5000)])
    # axes.set_yticks(np.arange(0, 6000, 1000))
    # axes.set_ylim(0, 5000)
    # axes.set_yticks(np.arange(0, 6250, 1250))
...
def draw_resource(rawDir, outputDir, exps):
    parallelismsPerJob = {}
...
exps_per_setting = {
    "linear_1": [
        ["Static",
         "part6and7-microbench-streamsluice-ds2-part6-linear-1split2join1-150-4000-4000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-300-1-1-5-510-1-1-1-300-1-1-1-300-1--0.05-0.1-1000-3000-100-1-false-1",
         "black", "o"],
        ["DS2",
         "part6and7-microbench-ds2-streamsluice-part6-linear-1split2join1-150-4000-4000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-300-1-1-5-510-1-1-1-300-1-1-1-300-1--0.05-0.1-1000-3000-100-1-true-1",
         # "part6and7-microbench-ds2-streamsluice-part6-linear-1split2join1-150-4000-4000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-300-1-1-5-510-1-1-1-300-1-1-1-300-1--0.05-0.1-1000-3000-100-1-true-2",
         # "part6and7-microbench-ds2-streamsluice-part6-linear-1split2join1-150-4000-4000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-300-1-1-5-510-1-1-1-300-1-1-1-300-1--0.05-0.1-1000-3000-100-1-true-3",
         "purple", "o"],
        ["Dhalion",
         "part6and7-microbench-dhalion-streamsluice-part6-linear-1split2join1-150-4000-4000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-300-1-1-5-510-1-1-1-300-1-1-1-300-1--0.05-0.1-1000-3000-100-1-true-1",
         # "part6and7-microbench-dhalion-streamsluice-part6-linear-1split2join1-150-4000-4000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-300-1-1-5-510-1-1-1-300-1-1-1-300-1--0.05-0.1-1000-3000-100-1-true-2",
         # "part6and7-microbench-dhalion-streamsluice-part6-linear-1split2join1-150-4000-4000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-300-1-1-5-510-1-1-1-300-1-1-1-300-1--0.05-0.1-1000-3000-100-1-true-3",
         "green", "o"],
        ["StreamSwitch",
         ...
         "orange", "o"],
        ["Sluice",
         "part6and7-microbench-streamsluice-streamsluice-part6-linear-1split2join1-150-4000-4000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-300-1-1-5-510-1-1-1-300-1-1-1-300-1--0.05-0.1-1000-3000-100-1-true-1",
         # "part6and7-microbench-streamsluice-streamsluice-part6-linear-1split2join1-150-4000-4000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-300-1-1-5-510-1-1-1-300-1-1-1-300-1--0.05-0.1-1000-3000-100-1-true-2",
         # "part6and7-microbench-streamsluice-streamsluice-part6-linear-1split2join1-150-4000-4000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-300-1-1-5-510-1-1-1-300-1-1-1-300-1--0.05-0.1-1000-3000-100-1-true-3",
         "blue", "o"],
    ],
    # "linear_1": [
    #     ["Static",
    #      "part6and7-microbench-streamsluice-ds2-part6-linear-1split2join1-150-5000-5000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-20-1-1-2-50-1-1-1-20-1-1-17-800-1--0.05-0.1-1000-3000-100-1-false-1",
    #      "black", "o"],
    #     ["DS2",
    ...
    # "sine_1": [
    #     ["Static",
    #      "part6and7-microbench-streamswitch-ds2-part6-sine-1split2join1-150-5000-5000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-20-1-1-2-50-1-1-1-20-1-1-17-800-1--0.05-0.1-1000-3000-100-1-false-3",
    #      "black", "o"],
    #     ["DS2",
    ...
    # "stair_1": [
    #     ["Static",
    #      "part6and7-microbench-streamswitch-ds2-part6-gradient-1split2join1-150-5000-5000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-20-1-1-2-50-1-1-1-20-1-1-17-800-1--0.05-0.1-1000-3000-100-1-false-3",
    #      "black", "o"],
    #     ["DS2",
    ...
    # "linear_2": [
    #     ["Static",
    #      "part6and7-microbench-streamswitch-ds2-part6-linear-1split2join1-150-5000-5000-960-linear-1000-1-1440-stair_3-120-1-1440-stair_3-1-0-1-20-1-1-2-50-1-1-1-20-1-1-17-800-1--0.05-0.1-1000-3000-100-1-false-3",
    #      "black", "o"],
    #     ["DS2",
