...
exps_per_setting = {
    "linear_1": [
        ["Static",
         "part6and7-microbench-streamsluice-ds2-part6-linear-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-2-444-1-10000-2-444-1-10000-2-444-1-10000-5-500-10000-0.00-0.1-2000-3000-100-10-false-1",
         "black", "o"],
        ["Earlier",
         "part6and7-microbench-streamsluice_earlier-streamsluice-part6-linear-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-2-444-1-10000-2-444-1-10000-2-444-1-10000-5-500-10000-0.00-0.1-2000-3000-100-10-true-1",
         "green", "o"],
        ["Later",
         "part6and7-microbench-streamsluice_later-streamsluice-part6-linear-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-2-444-1-10000-2-444-1-10000-2-444-1-10000-5-500-10000-0.00-0.1-2000-3000-100-10-true-1",
         "orange", "o"],
        # ["DS2",
        ...
        #  "purple", "o"],
        # ["Dhalion",
        #  "part6and7-microbench-dhalion-streamsluice-part6-linear-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-120-1-1440-stair_3-1-0-2-300-1-5000-2-300-1-5000-2-300-1-5000-6-510-5000-0.00-0.1-2000-3000-100-1-true-1",
        #  "green", "o"],
        # ["StreamSwitch",
        ...
        #  "orange", "o"],
        ["Sluice",
         "part6and7-microbench-streamsluice-streamsluice-part6-linear-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-2-444-1-10000-2-444-1-10000-2-444-1-10000-5-500-10000-0.00-0.1-2000-3000-100-10-true-1",
         "blue", "o"],
    ],
    # "linear_1": [
    #     ["Static",
