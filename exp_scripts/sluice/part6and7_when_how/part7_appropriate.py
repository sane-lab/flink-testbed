...
exps_per_setting_bottleneck = {
    ...
    "part7_quarter-sine_1": [
        ["Static",
         ...
         "black", "x--"],
        ["More",
         "part6and7-microbench-streamsluice-streamsluice_more-800-part7-quarter-sine-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-3-444-1-5000-3-444-1-5000-3-444-1-5000-5-500-5000-0.00-0.1-2000-3000-100-10-true-1",
         "green", "^-"],
        ["Less",
         "part6and7-microbench-streamsluice-streamsluice_less-800-part7-quarter-sine-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-3-444-1-5000-3-444-1-5000-3-444-1-5000-5-500-5000-0.00-0.1-2000-3000-100-10-true-1",
         "orange", "s-"],
        ["Minus_one",
         "part6and7-microbench-streamsluice-streamsluice_minus_one-800-part7-quarter-sine-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-3-444-1-5000-3-444-1-5000-3-444-1-5000-5-500-5000-0.00-0.1-2000-3000-100-10-true-3",
         "purple", "d-"],
        ["No_Balance",
         "part6and7-microbench-streamsluice-streamsluice_no_balance-800-part7-quarter-sine-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-3-444-1-5000-3-444-1-5000-3-444-1-5000-5-500-5000-0.00-0.1-2000-3000-100-10-true-1",
         "olive", "p-"],
        ["Sluice",
    ...
    "part7_gradient_1": [
        ...
        ["More",
         ...
         "green", "^-"],
        ["Less",
         "part6and7-microbench-streamsluice-streamsluice_less-800-part7-gradient-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-3-444-1-5000-3-444-1-5000-3-444-1-5000-5-500-5000-0.00-0.1-2000-3000-100-10-true-1",
         "orange", "s-"],
        ["Minus_one",
         "part6and7-microbench-streamsluice-streamsluice_minus_one-800-part7-gradient-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-3-444-1-5000-3-444-1-5000-3-444-1-5000-5-500-5000-0.00-0.1-2000-3000-100-10-true-1",
         "purple", "d-"],
        ["No_Balance",
...
exps_per_setting_not_bottleneck = {
    ...
    #      "black", "x--"],
    #     ["Not_Bottleneck",
    #      "part6and7-microbench-streamsluice-streamsluice_not_bottleneck-800-part7-quarter-sine-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-3-444-1-5000-3-444-1-5000-3-444-1-5000-5-500-5000-0.00-0.1-2000-3000-100-10-true-1",
    #      "orange", "^-"],
    #     ["Sluice",
    #      "part6and7-microbench-streamsluice-streamsluice-800-part6-quarter-sine-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-3-444-1-5000-3-444-1-5000-3-444-1-5000-5-500-5000-0.00-0.1-2000-3000-100-10-true-1",
    #      "blue", "o-"],
    ...
    #      "black", "x--"],
    #     ["Not_Bottleneck",
    #      "part6and7-microbench-streamsluice-streamsluice_not_bottleneck-800-part7-gradient-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-3-444-1-5000-3-444-1-5000-3-444-1-5000-5-500-5000-0.00-0.1-2000-3000-100-10-true-1",
    #      "orange", "^-"],
    #     ["Sluice",
    #      "part6and7-microbench-streamsluice-streamsluice-800-part6-gradient-1split2join1-120-4000-4000-960-linear-2000-1-1440-stair_3-80-1-1440-stair_3-1-0-3-444-1-5000-3-444-1-5000-3-444-1-5000-5-500-5000-0.00-0.1-2000-3000-100-10-true-1",
    #      "blue", "o-"],
...
for name, exps_per_setting in exps_per_settings.items():
    fig, axs = plt.subplots(3, 3, figsize=(20, 7), layout='constrained')
    ...
    for workload, exps in exps_per_setting.items():
        ...
        if workload == "part7_linear_1":
            startTime = 55
            expLength = 30
        elif workload == "part7_quarter-sine_1":
            startTime = 55
            expLength = 30
        elif workload == "part7_sine_1":
            startTime = 50
            expLength = 30
        elif workload == "part7_gradient_1":
            startTime = 52
            expLength = 30
        else:
            startTime = 52
