...
exps = {
    ...
    "Linear_Road": [
        ["Static",
         ...
         "system-true-streamsluice-ds2-true-true-false-when-mixed-1split2join1-760-6000-3000-4000-1-0-2-300-1-5000-2-300-1-5000-2-300-1-5000-6-510-5000-1000-3000-100-1-false-1",
         "green", "o"],
        # ["Earlier",
        ...
        ["Sluice",
         ...
         "system-true-streamsluice-streamsluice-true-true-false-false-when-mixed-1split2join1-520-6000-3000-4000-1-0-1-50-1-5000-1-50-1-5000-1-50-1-5000-6-530-5000-2000-3000-100-1-true-1",
         "blue", "o"],
...
for app in exps.keys():
    ...
    exp_length = 480 #480 #480 #360 #1800
    startTime = 30 # + 300
    print(expName)
