...
def main():
    ...
    exps_per_label_per_setting = {
        "Microbench_1": {
            ...
            #"static":
            "scale": [
                "part4-microbench-5-1.2-1-8-part4-mixed-1split2join1-1880-600-600-600-5000-5000-5000-2500-2000-1500-120-150-180-sine-qsine-qsine-1-0-1-20-1-10000-20-2050-1-10000-1-20-1-10000-1-10-10000-0.05-true-0.5-3000-500-100-1-true-1",
            ],
        }
    }
