...
def main():
    ...
    exps_per_label_per_setting = {
        "Microbench_1": {
            ...
            #"static":
            "scale": [
                "part4-microbench-3-1000-10-10-part4-mixed-1split2join1-920-200-240-300-5000-5000-5000-1500-2500-1000-200-120-300-qsine-qsine-qsine-1-0-1-20-1-10000-20-2050-1-10000-1-20-1-10000-1-10-10000-0.05-true-0.8-2000-500-100-1-true-1",
            ],
        }
    }
