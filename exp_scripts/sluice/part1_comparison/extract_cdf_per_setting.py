...
def main():
    ...
    exps_per_label_per_setting = {
        ...
        "Stock-Analysis_30min":{
            ...
            "Sluice": "stock-streamsluice-streamsluice-5-8-1350-90-1000-20-1-200-11-2500-1-200-2-500-1-15-3333-1000-100-0.1-true-true-1",
        },
        # "Linear-Road_30min": {
        ...
        #     "Sluice": "lr-streamsluice-streamsluice-5-8-60-1980-150-1300-10-1-50-3-1000-1-50-27-2500-2000-0.1-100-1-0-0.0-true-1000-0.8-2",
        # },
    }
