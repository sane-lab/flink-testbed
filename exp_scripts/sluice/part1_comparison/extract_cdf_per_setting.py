...
def main():
    ...
    exps_per_label_per_setting = {
        ...
        "(b) Stock": {
            ...
            "ContTune": "stock-conttune-conttune-5-8-60-1350-90-1000-20-1-200-7-3333-1-200-2-500-1-12-5000-2000-100-0.2-true-false-2",
    ...
    fig.legend(handles=legend_elements, loc='upper center', bbox_to_anchor=(0.5, 1.14), ncol=7, markerscale=5)
