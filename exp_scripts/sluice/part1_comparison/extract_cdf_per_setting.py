...
def plot_latency_curves(latency_curves, latency_limit, output_dir, start_time, exp_length, workload_name: str, ax, ylabel_flag):
    ...
    ax.set_title(workload_name, y=-0.7, fontsize=FONT_SIZE + 8)
...
def main():
    ...
    exps_per_label_per_setting = {
        ...
        "(b) Stock Analysis": {
            ...
            "Static": "stock-ds2-ds2-5-8-60-1350-90-1000-20-1-200-4-3333-1-200-1-500-1-7-5000-2000-100-0.2-false-false-3",
            "DS2": "stock-ds2-ds2-5-8-60-1350-90-1000-20-1-200-11-3333-1-200-2-500-1-15-5000-2000-100-0.2-true-false-3",
            "StreamSwitch": "stock-streamswitch-streamswitch-5-8-60-1350-90-1000-20-1-200-11-3333-1-200-2-500-1-15-5000-2000-100-0.2-true-false-3",
    ...
    fig.legend(handles=legend_elements, loc='upper center', bbox_to_anchor=(0.53, 1.11), ncol=6, markerscale=5)
