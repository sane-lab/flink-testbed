...
def plot_parallelism_vs_our_limit(outputDir, setting_name, data):
    """
    Plots 'average parallelism' vs 'our limit' from the given data.

    :param data: List of [our limit, P99 latency limit, success rate, average parallelism]
    """
    our_limits = [entry[0] for entry in data]
    ...
    plt.xlabel('Our Latency Limit')
    plt.ylabel('Average Parallelism')
    plt.title('Average Parallelism vs Our Latency Limit')
...
data_under_settings = {
    ...
    [
        [310, 523, 319, 0.945041816009558, 13.25645],
        [325, 472, 328, 0.9444776119402986, 13.20138],
        [350, 412, 303, 0.9829850746268657, 13.111133333333333],
...
for setting_name, data in data_under_settings.items():
    ...
    plot_parallelism_vs_our_limit(outputDir, setting_name, data)
