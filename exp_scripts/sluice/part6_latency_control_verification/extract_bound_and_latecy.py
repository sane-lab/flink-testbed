...
def main():
    ...
    exps_per_label_per_setting = {
        "Microbench_1": {
            "scale": [
                "part6-microbench-streamsluice-ds2-part6-mixed-1split2join1-690-4000-6000-300-linear-500-2000-450-linear-120-60-240-linear-1-0-1-20-1-5000-2-50-1-5000-1-20-1-5000-17-800-5000--0.05-0.2-1000-3000-100-1-false-1",
                "part6-microbench-streamsluice-streamsluice-part6-mixed-1split2join1-690-4000-6000-300-linear-500-2000-450-linear-120-60-240-linear-1-0-1-20-1-5000-2-50-1-5000-1-20-1-5000-17-800-5000--0.05-0.1-1000-3000-100-1-true-1",
                "part6-microbench-streamsluice-streamsluice-part6-mixed-1split2join1-690-4000-6000-300-linear-500-2000-450-linear-120-60-240-linear-1-0-1-20-1-5000-2-50-1-5000-1-20-1-5000-17-800-5000--0.05-0.1-2000-3000-100-1-true-1",
            ]
        }
    }
    for workload_name, exps_per_label in exps_per_label_per_setting.items():
        ...
        for label, exps in exps_per_label.items():
            ...
            for exp_name in exps:
                if exp_name.startswith("part6-microbench"):
