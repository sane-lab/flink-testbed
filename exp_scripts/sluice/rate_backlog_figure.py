...
def draw_for_file(rawDir, expName, outputDir):
    ...
    def draw_metrics_within_time_range(times, arrival_rates, service_rates, backlogs, task_name, start_time, end_time):
        ...
        filtered_times = [t for t in times if start_time <= t <= end_time]
        ...
        ax1.plot(filtered_times, filtered_arrival_rates, label='Arrival Rate', color='tab:blue', linestyle='-')
        ax1.plot(filtered_times, filtered_service_rates, label='Service Rate', color='tab:cyan', linestyle='--')
        ax1.tick_params(axis='y', labelcolor='tab:blue')
        ax1.set_ylim(0, 5000)
        # Create a second y-axis for backlog
        ax2 = ax1.twinx()
        ax2.set_ylim(0, 10000)
        ax2.set_ylabel('Backlog', color='tab:red')
        ax2.plot(filtered_times, filtered_backlogs, label='Backlog', color='tab:red', linestyle='-')
    ...
    for task, data in task_data.items():
        draw_metrics_within_time_range(data['time'], data['arrival_rate'], data['service_rate'], data['backlog'], task, start_time, end_time)
...
exps = [
    ...
    "test_metric-streamsluice-ds2-true-false-true-false-when-gradient-4op_line-170-6000-4000-4000-1-0-2-300-1-5000-2-300-1-5000-2-50-1-5000-3-600-5000-1000-3000-100-1-false-1",
    "test_metric-streamsluice-ds2-false-false-true-false-when-gradient-4op_line-170-6000-4000-4000-1-0-2-300-1-5000-2-300-1-5000-2-50-1-5000-3-600-5000-1000-3000-100-1-false-1",
    "test_metric-streamsluice-streamsluice-true-false-true-false-when-linear-4op_line-170-6000-4000-4000-1-0-2-300-1-5000-2-300-1-5000-2-50-1-5000-3-600-5000-1000-3000-100-1-true-1",
    "test_metric-streamsluice-streamsluice-false-false-true-false-when-linear-4op_line-170-6000-4000-4000-1-0-2-300-1-5000-2-300-1-5000-2-50-1-5000-3-600-5000-1000-3000-100-1-true-1",
    "test_metric-streamsluice-streamsluice-true-false-true-false-when-linear-1split2join1-170-6000-4000-4000-1-0.1-2-300-1-5000-2-300-1-5000-2-50-1-5000-3-600-5000-1000-3000-100-1-true-1",
    "test_metric-streamsluice-streamsluice-false-false-true-false-when-linear-1split2join1-170-6000-4000-4000-1-0.1-2-300-1-5000-2-300-1-5000-2-50-1-5000-3-600-5000-1000-3000-100-1-true-1",
]
start_time=30
end_time=120
