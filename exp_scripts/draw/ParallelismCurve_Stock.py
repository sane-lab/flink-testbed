...
def readParallelism(rawDir, expName):
    ...
    job = operatorNameToId[sorted(operatorNameToId.keys())[0]]
    return [ParallelismPerJob["TOTAL"], totalArrivalRatePerJob[job], initialTime]
...
def draw(rawDir, outputDir, exps):
    ...
    fig, ax1 = plt.subplots(figsize=(24, 5)) #plt.figure(figsize=(12, 4))
    ax2 = ax1.twinx()
    legend = []
    for expindex in range(0, len(exps)):
        print("Draw exps " + exps[expindex][0] + " curve...")
        Parallelism = parallelisms[expindex]
    ...
    ax = sorted(totalArrivalRates[0].keys())
    #print(totalArrivalRatePerJob[job])
    ay = [totalArrivalRates[0][x] / (windowSize / 100) for x in ax]
...
exps = [
    ...
    # statesize=2000
    ["StreamSluice",
     "stock-sb-4hr-50ms.txt-streamsluice-streamsluice-3690-30-1000-20-2-1000-1-2000-3-2000-1-2000-7-5000-1-2000-2000-100-true-1",
     "blue"],
    ["StreamSwitch",
     "stock-sb-4hr-50ms.txt-streamswitch-streamswitch-3690-30-1000-20-2-1000-1-2000-3-2000-1-2000-7-5000-1-2000-2000-100-true-1",
     "green"],
    ["DS2", "stock-sb-4hr-50ms.txt-ds2-ds2-3690-30-1000-20-2-1000-1-2000-3-2000-1-2000-7-5000-1-2000-2000-100-true-1",
     "purple"],
    ["Static-1",
