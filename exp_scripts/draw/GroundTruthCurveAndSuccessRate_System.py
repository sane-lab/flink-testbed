...
exps = [
    ["StreamSluice", "microbench-system-time_29-streamsluice-3op-60-4000-6000-5000-1000-20-1-0-2-250-1-1000-3-444-1-1000-5-1000-1-1000-2000-2000-100-true-1", "blue"],
]
import sys
if len(sys.argv) > 1:
