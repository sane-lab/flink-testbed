...
exps = [
    ["StreamSluice", "microbench-system-streamsluice-streamsluice-gradient-3op-60-4000-8000-6000-2000-20-1-0-2-222-1-10000-2-222-1-10000-5-1000-1-10000-2000-2000-100-10-true-1", "blue"],
    #["StreamSluice-1", "microbench-system-time_160-streamsluice_more-gradient-3op-60-4000-6000-5000-1000-20-1-0-3-444-1-10000-3-444-1-10000-5-1000-1-10000-2000-2000-100-10-true-1", "green"],
    #["StreamSluice-2", "microbench-system-time_160-streamsluice_less-gradient-3op-60-4000-6000-5000-1000-20-1-0-3-444-1-10000-3-444-1-10000-5-1000-1-10000-2000-2000-100-10-true-1", "orange"],
]
import sys
if len(sys.argv) > 1:
