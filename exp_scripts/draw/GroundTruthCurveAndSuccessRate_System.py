...
exps = [
    ["StreamSluice", "microbench-system-streamsluice-op_1_3_keep-gradient-3op-60-4000-4000-5000-1000-10-1-0-3-444-1-10000-3-444-1-10000-5-1000-1-10000-2000-2000-100-10-true-1", "blue"],
    ...
    ["StreamSluice-2", "microbench-system-time_170-op_1_3_keep-gradient-3op-60-4000-4000-5000-1000-10-1-0-3-444-1-10000-3-444-1-10000-5-1000-1-10000-2000-2000-100-10-true-1", "orange"],
]
import sys
if len(sys.argv) > 1:
