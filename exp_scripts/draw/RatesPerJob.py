    ...
    if(drawOperatorFigureFlag):
        ...
        for i in range(0, len(totalArrivalRatePerJob.keys())):
            ...
            if(not expName.startswith("stock")):
                lastTime = initialTime + endTime * 1000
                ax1.set_xlim(0, lastTime - initialTime)
...
expName = "microbench-system-time_160-streamsluice_less-gradient-3op-60-4000-6000-5000-1000-20-1-0-3-444-1-10000-3-444-1-10000-5-1000-1-10000-2000-2000-100-10-true-1"
