...
def DrawLegend(xvalues, yvalues, legend_labels, x_label, y_label, y_label_2, filename, allow_legend):
    fig, ax1 = plt.subplots(figsize=(10, 5))
    ax2 = plt.twinx()
    ...
    # LEGEND
    figlegend = plt.figure(figsize=(11, 0.5))
