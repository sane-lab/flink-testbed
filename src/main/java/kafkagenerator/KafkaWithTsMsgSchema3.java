...
public class KafkaWithTsMsgSchema3 implements KafkaDeserializationSchema<Tuple2<String, String>>, SerializationSchema<Tuple2<String, String>> {
    ...
    public KafkaWithTsMsgSchema3() {
        this(Charset.forName("UTF-8"));
    }

    public KafkaWithTsMsgSchema3(Charset charset) {
