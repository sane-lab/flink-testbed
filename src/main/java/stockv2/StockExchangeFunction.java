...
public class StockExchangeFunction extends KeyedProcessFunction<String, Quote, String> {
...
//    private transient MapState<String, Map<String, NavigableMap<Double, PriorityQueue<Quote>>>> ordersState;
    private transient MapState<String, String> ordersState;

    public StockExchangeFunction(int perKeyStateSize) {
...
//        Quote stockOrders = ordersState.get(quote.acctId);
//        if (stockOrders == null) {
...
//        matchOrders(quote.stockId, stockOrders, out);
        ...
        ordersState.put(quote.acctId, quote.toString());
    }
