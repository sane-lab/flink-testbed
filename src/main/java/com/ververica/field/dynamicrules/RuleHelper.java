...
public class RuleHelper {
  ...
  /* Picks and returns a new accumulator, based on the ControlMessage's aggregator function type. */
  public static SimpleAccumulator<BigDecimal> getAggregator(ControlMessage controlMessage) {
    switch (controlMessage.getAggregatorFunctionType()) {
      case SUM:
      ...
      default:
        throw new RuntimeException(
            "Unsupported aggregation function type: " + controlMessage.getAggregatorFunctionType());
    }
  }
}
