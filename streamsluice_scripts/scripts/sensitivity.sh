...
#    printf "${EXP_NAME}\n" >> whetherhow_result.txt
#    is_treat=true
    for how_type in "streamsluice_not_bottleneck"; do #"streamsluice_minus_one" "streamsluice_less"; do #"streamsluice_no_balance"  "streamsluice_more"  "streamsluice_not_bottleneck"; do
      run_one_exp
      printf "${EXP_NAME}\n" >> whetherhow_result.txt
    done
    how_type="streamsluice"
