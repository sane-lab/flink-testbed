...
#FLINK_DIST_CONF_DIR="/home/samza/workspace/flink-related/flink-extended-ete/flink-dist/target/flink-1.8.1-bin/flink-1.8.1/conf"
...
#      #scp ${FLINK_CONF_DIR}/flink-conf-slave.yaml ${host}:${FLINK_DIST_CONF_DIR}/flink-conf.yaml
#    done
}
