...
#            printf "${EXP_NAME}\n" >> part6and7_result.txt
    ...
    for CURVE_TYPE in "quarter-sine" "gradient"; do # "linear" "quarter-sine" "gradient"
      for amplitude_low in 2000; do
        is_treat=false
        autotune=false
        how_type="ds2"
        ...
        printf "${EXP_NAME}\n" >> part6and7_result.txt
        whether_type="streamsluice"
        for how_type in "streamsluice_more" "streamsluice_less" "streamsluice_minus_one" "streamsluice_no_balance" "streamsluice_not_bottleneck"; do # "streamsluice_more" "streamsluice_less" "streamsluice_minus_one" "streamsluice_no_balance" "streamsluice_not_bottleneck"
          for repeat in 1 2 3; do
            is_treat=true
            autotune=true
            run_one_exp
