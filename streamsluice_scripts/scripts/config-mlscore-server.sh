#!/usr/bin/env bash
FLINK_DIR="/home/samza/workspace/flink-related/flink-extended-ete/build-target_copied"
...
# configure parameters in flink bin - ML Scoring Job specific
function configFlink() {
    ...
    cp ${FLINK_CONF_DIR}/flink-conf-mlscore.yaml ${FLINK_DIR}/conf/flink-conf.yaml
